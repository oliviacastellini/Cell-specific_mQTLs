---
title: "Comparison of mQTLs associations across contexts"
...
# Read in clumped
load("/user/home/uy23281/16_clumped.rdata")
...
for (i in 1:7) {
  ...
  chunk_file <- paste0("/user/home/uy23281/model4/neu/EPIC_mQTL/results/05/SortedNeu.res.cis.", i, ".RData")
  cell <- fread(chunk_file)

  # Subset the current chunk based on the clumped$cpg values
  cell <- subset(neu, gene %in% clumped$cpg)
